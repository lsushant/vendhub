...
@RestController
@RequestMapping("/api/vendhub-kafka")
public class VendhubKafkaResource {

    private final Logger log = LoggerFactory.getLogger(VendhubKafkaResource.class);
    ...
    public VendhubKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
